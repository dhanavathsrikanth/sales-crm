    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <div className="rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-100">
              ...
              <Link href="/construction/orders" className="text-sm text-emerald-600 hover:underline">View all</Link>
            </div>
                ...
                recentOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${statusColors[order.status ?? "pending"]}`}>
                        {order.status}
                      </span>
                    </div>
                  </Link>
        ...
        <div>
          <div className="rounded-xl border border-zinc-200 bg-white">
            <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-100">
              <h2 className="font-semibold text-zinc-900">Lead Pipeline</h2>
              <Link href="/construction/leads" className="text-sm text-emerald-600 hover:underline">View all</Link>
            </div>
